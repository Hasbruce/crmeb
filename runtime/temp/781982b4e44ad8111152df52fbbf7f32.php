<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\wamp\www\study\crmeb/application/admin\view\widget\icon.php";i:1554200062;}*/ ?>
...
//            document.onselectstart = new Function('event.returnValue=false;');
            $('.list-inline li').on('click', function () {
                ...
                if (className) {
                    ...
                    parent.$f.changeField("<?php echo \think\Request::instance()->param('fodder'); ?>",font);
                    parent.$f.closeModal();
                }
            });
            //清空选择
            $('#qingkong').on('click', function () {
                parent.$f.changeField("<?php echo \think\Request::instance()->param('fodder'); ?>",'');
                parent.$f.closeModal();
