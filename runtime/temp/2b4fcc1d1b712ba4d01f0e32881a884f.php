<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:62:"E:\wamp\www\study\crmeb/application/admin\view\login\index.php";i:1554200062;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="middle-box text-center loginscreen  animated fadeInDown">
    <div class="login-group">
        <h3 class="login-logo">
            <img src="/public/system/images/logo.png">
        </h3>
        <form role="form" action="<?php echo url('verify'); ?>" method="post">
...
<script src="/public/system/frame/js/bootstrap.min.js?v=3.4.0"></script>
<script src="/public/system/module/login/flaotfont.js"></script>
<script src="/public/system/module/login/ios-parallax.js"></script>
<script src="/public/system/module/login/index.js"></script>
<!--统计代码，可删除-->
<!--点击刷新验证码-->
</body>
</html>